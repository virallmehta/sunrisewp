<?php
    class artooz_instagram_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( 'instagram-widget', 'Artooz Instagram Widget', $widget_ops );
        }
        ...
        function form( $instance ) {
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', AR_DOMAIN ); ?>
                    :</label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of Photos', AR_DOMAIN ); ?>
                    :</label>
    ...
    add_action( 'widgets_init', 'swasti_load_instagram_widget' );

    function swasti_load_instagram_widget() {
        register_widget( 'swasti_instagram_widget' );
    }
