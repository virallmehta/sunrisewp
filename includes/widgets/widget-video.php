<?php
    class artooz_video_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            $control_ops = array( 'width' => 250, 'height' => 200, 'id_base' => 'video-widget' ); 
            parent::__construct( 'ar_video-widget', 'Artooz Video Widget', $widget_ops, $control_ops );
        }
    ...
    add_action( 'widgets_init', 'artooz_load_video_widget' );

    function artooz_load_video_widget() {
        register_widget( 'artooz_video_widget' );
    }
