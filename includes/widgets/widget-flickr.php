<?php
	class swasti_flickr_widget extends WP_Widget {
	...
	?>
		<p>
	        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', ST_DOMAIN);?>:</label>
	        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	    </p>
	
		<p>
			<label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e('Flickr ID', ST_DOMAIN);?>:</label>
	...
	add_action( 'widgets_init', 'swasti_load_flickr_widget' );
	
	function swasti_load_flickr_widget() {
		register_widget('swasti_flickr_widget');
	}
